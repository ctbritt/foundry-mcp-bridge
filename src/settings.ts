...
export class ModuleSettings {
  ...
  registerSettings(): void {
    ...
    game.settings.register(this.moduleId, 'useTwoStageWorkflow', {
      ...
      hint: 'For RunPod only: Generate at lower resolution with base model, then upscale and refine with upscale model. Better quality but takes longer. Requires both dDBattlemapsSDXL10_v10.safetensors and dDBattlemapsSDXL10_upscaleV10.safetensors on your RunPod instance.',
      scope: 'world',
